...
const RealTimeHeader = ({ type, icon, colour, stopID, stopLocation, availableOptions, changeValue }) => (
  <div
    className="realTimeHeader" style={{ backgroundColor: colour }}>
    <div
      ...
      <div
        ...
        <Link
          href="/">
          <a><FontAwesomeIcon
            icon={faChevronCircleLeft} title="Back to Home"/></a>
        </Link>
      </div>
      <div
        className="column is-narrow">
    ...
    <SearchBox
      defaultValue={stopID} availableOptions={availableOptions} changeValue={changeValue}/>
  </div>
);
