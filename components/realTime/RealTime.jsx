...
const RealTime = ({type, colour, icon, stopID, stopLocation, stopCoords, results, changeValue}) => (
    <div className="columns realTime">
        <div className="column">
            <RealTimeHeader type={type} icon={icon} colour={colour} stopID={stopID} stopLocation={stopLocation} changeValue={changeValue}/>
            <br/>
